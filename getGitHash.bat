...
@ECHO #include "parabolicDesignApp.h">> %outputPath%%outputFile%
@ECHO.>> %outputPath%%outputFile%
@ECHO const wxString ParabolicDesignApp::versionString = _T("%gitTag%");>> %outputPath%%outputFile%
@ECHO const wxString ParabolicDesignApp::gitHash = _T("%gitHash%");>> %outputPath%%outputFile%
